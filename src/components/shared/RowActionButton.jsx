 ...
 *
 * Standard size: h-6 (24px, WCAG 2.2 min target) / 11px / weight 500 / px 9px /
 * radius 7px (rounded-btn), vertically centered, filled brand, white text,
 * hover darkens (brightness-90), keyboard focus ring.
 */
export const ROW_ACTION_BASE =
  "text-[11px] font-medium whitespace-nowrap cursor-pointer font-[inherit] " +
  "h-6 inline-flex items-center justify-center bg-brand text-white hover:brightness-90 " +
 ...
 * (e.g. Dismiss). 11px / weight normal / `c.hint` (text-hint) / h-6 (24px,
 * vertically centered) / px 6px, transparent, no border. Adds a hover darken
 * and a keyboard focus ring. Still applied to a <button> element.
 */
export const ROW_ACTION_LINK =
  "text-[11px] font-normal whitespace-nowrap cursor-pointer font-[inherit] " +
  "h-6 inline-flex items-center bg-transparent text-hint px-1.5 rounded-btn hover:text-muted " +
  "focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-1";
